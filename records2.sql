...
INSERT INTO `users` (`id`, `fullname`, `password`, `email`, `phone`, `address`, `role`, `approved`) VALUES
(3, 'Adriane James', '364dbff1c847a840c157617301b7160c8fe91f9d5b847044f455c758e29accd7', 'adrianejames03@gmail.com', '09983082814', '#3853 Macabulos St. Bangkal, Makati City', 'user', 0),
(4, 'Adriane James', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'adrianejames27@gmail.com', '09983082814', '#3853 Macabulos St. Bangkal, Makati City', 'admin', 1);
...
--
ALTER TABLE `employees`
  MODIFY `EmployeeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
